                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="row" style="display: {{ $display1 }};">
                                    <div class="col-md-4">
                                        <button class="btn btn-custon-rounded-three btn-success" wire:click="assignedAssetPage" style="display: {{ $display1 }};"><i class="fa fa-check-circle-o"></i> Assigned Assets</button>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="basic-login-form-ad" style="margin-left: 20px; margin-right: 20px;">                                    
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row" style="margin-bottom: 20px;">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row" style="align-content: left;">
                                                    <div class="col-12">
                                                        <label for="acqtype">Department</label>
                                                    </div>
                                                    <div class="col-12" style="margin-top: 8px;">
                                                        <select wire:model="department_id" class="form-control" name="assettype_id" id="assettype_id">
                                                            <option value="" selected style="font-weight: bold;">Select Department</option>
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row" style="margin-bottom: 20px;">
                                            ...
                                            <div class="col-md-{{ $bdCol }}" style="display: {{ $buildingDisplay }}">
                                                <div class="row">
                                                    <div class="col-12">
                                    ...
                                    <div class="form-group-inner" style="display: {{ $floorDisplay }}">
                                        <div class="row" style="margin-bottom: 20px;">
                                        ...
                                        <div class="row" style="margin-bottom: 20px;">
                                            <div class="col-md-6">
                                                <div class="row" style="align-content: left; margin-right: 20px;">
                                                    ...
                                                    <div class="col-12" style="margin-top: 8px;">
                                                        <p>{{ $storeKeeper->first_name . ' ' . $storeKeeper->last_name }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row" style="align-content: left;">
                                                    ...
                                                    <div class="col-12" style="margin-top: 8px;">
                                                        @foreach ($employeeToAssign as $employee)
                                                            @if (!empty($role_id) && ($role_id == $employee->role_id) && ($employee->role->name == 'director') && !empty($department_id) && ($department_id == $employee->department_id))
                                                                <p>{{ $headOfDepartment }}</p>

                                                            @elseif (!empty($role_id) && ($role_id == $employee->role_id)  && ($employee->role->name == 'head of section') && !empty($department_id) && ($department_id == $employee->department_id) && !empty($section_id) && ($section_id == $employee->section_id))
                                                                <p>{{ $headOfSection }}</p>
                                                            
                                                            @elseif (!empty($role_id) && ($role_id == $employee->role_id)  && ($employee->role->name == 'head of office') && !empty($department_id) && ($department_id == $employee->department_id) && !empty($section_id) && ($section_id == $employee->section_id) && !empty($room_id) && ($room_id == $employee->room_id))
                                                                <p>{{ $headOfOffice }}</p>
