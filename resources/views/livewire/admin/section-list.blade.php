                    ...
                    <button type="submit" class="btn btn-primary">Save</button>
                            ...
                            <div class="col-lg-6">
                                <ul class="breadcome-menu">
                                    ...
                                    <li><span class="bread-blod">Department Sections</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true"  data-show-refresh="true" data-key-events="true"  data-resizable="true"  data-click-to-select="true" class="table table-hover">
                                    ...
                                    <tbody>
                                            ...
                                            $i=1;
                                            @endphp
                                        @forelse ($sectionsWithHeadOfSection as $section)
                                        <tr>
                                            <td>{{$i++}}</td>
                                            <td>{{$section->name}}</td>
                                            ...
                                            <td>
                                                @foreach ($employees as $employee)
                                                    @if (($employee->section_id == $section->id) && ($employee->role_id == $employee->role->id) && ($employee->role->name == 'head of section'))
                                            ...
                                            <td>
                                                <button type="button" wire:click="getSectionDetails({{ $section->id }})" class="btn btn-primary btn-circle" data-toggle="modal" data-target="#editSection"><i class="fa fa-edit"></i></button>
                                                @php
                                                        ...
                                                        @endphp
                                                        <button type="button" class="btn btn-{{ $btncolor }}" wire:click="ShowSoftDeleteModal({{ $section->id }})" data-toggle="modal" data-target="#activateSectionModal"><i class="fa fa-power-off"></i></button>
                                            </td>
                                        </tr>
                                        @empty
                                            <tr><td style='color:red; text-align:center;' colspan='5' >No Section Found!</td></tr>
                                        @endforelse

                                    </tbody>
                                </table>
                                </table>
                                {{ $sectionsWithHeadOfSection->links() }}
                                ...
                                <div id="editSection" wire:ignore.self class="modal modal-adminpro-general fullwidth-popup-AddSectionModal fade" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                                ...
                                                <form wire:submit.prevent="EditSection({{ $section_id }})">
                                 ...
                                 {{-- Delete modal --}}
                                 <div wire:ignore.self id="activateSectionModal" class="modal modal-adminpro-general fullwidth-popup-activateSectionModal fade" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                                <form wire:submit.prevent="SoftDeleteSection({{ $section_id }})">
