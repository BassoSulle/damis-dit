                      ...
                      <div class="row">
                          <div class="col-lg-12">
                              <div class="breadcome-list shadow-reset">
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <button class="btn btn-custon-rounded-three btn-success" data-toggle="modal" data-target="#AddEmployeeModalalert"><i class="fa fa-user"></i> Register Employee</button>
                                                  ...
                                                  <div class="basic-login-inner">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 mb-3" style="display: {{ $sectionsDisplay }};">
                              ...
                              <div class="sparkline13-list shadow-reset">
                                  ...
                                  <div class="sparkline13-graph">
                                          ...
                                          <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true"  data-show-refresh="true" data-key-events="true"  data-resizable="true"  data-click-to-select="true" class="table table-hover">
                                              ...
                                              <tbody>
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td>
                                                        @if (!empty($employee->section_id) && ($employee->role->name == 'head of section'))
                                                            {{$employee->section->name}}
                                                                          
                                                        @endif
                                                      </td>
                                                      <td>
                                                        @if (!empty($employee->room_id))
                                                            {{$employee->room['name']}}

                                                        @elseif (empty($employee->room_id))
                                                            N/A
                                                        @endif
                                                      </td>
                                    ...
                                    <div id="activateEmployeeModal" wire:ignore.self class="modal modal-adminpro-general fullwidth-popup-activateEmployeeModal fade" role="dialog">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                        <form wire:submit.prevent="SoftDeleteEmployee({{ $employee_id }})">
                                    ...
                                    <div>
                                        <div id="EditEmployeeModal" wire:ignore.self class="modal modal-adminpro-general fullwidth-popup-EditEmployeeModal fade" role="dialog">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                        <form wire:submit.prevent="EditEmployee({{ $employee_id }})">
