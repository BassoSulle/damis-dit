                                    ...
                                    <table wire:ignore.self id="table" class="table table-hover">
                                        ...
                                        <tr {{ $assigned_asset->id }}>
                                            ...
                                            <td>
                                                ...
                                                @if (empty($assigned_asset->assigned_by) && empty($assigned_asset->headOfDepartment_id))
                                                        N/A
                                                @endif
                                            </td>
                                        ...
                                        @empty
                                            <tr><td style='color:red; text-align:center;' colspan='5' >No Asset to assign!</td></tr>
                                        @endforelse
                                                    ...
                                                    <div class="row" style="align-content: left; margin-right: {{ $margin }};">
                                                        ...
                                                        <div class="col-12" style="margin-top: 8px;">
                                                            <select wire:model="role_id"class="form-control" id="condtion_id">
                                                                <option value="{{ $role['id'] }}" selected style="font-weight: bold;">{{ $role->name }}</option>
                                                                @foreach ($roles as $role)
                                                                    @if (($role->name != 'head of section') && ($role->name != 'director') && ($role->name != 'estate') && ($role->name != 'store keeper') && ($role->name != 'stock checker'))
                                                    ...
                                                    <div class="row" style="align-content: left; margin-right: 20px;">
                                                        ...
                                                        <div class="col-12" style="margin-top: 8px;">
                                                            <select wire:model="building_id" id="" class="form-control">
                                                              <option value="" selected="selected" style="font-weight: bold;">Select Building</option>
