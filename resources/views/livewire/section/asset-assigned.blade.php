                                        ...
                                        <tr {{ $assigned_asset->id }}>
                                            ...
                                            <td>
                                                @foreach ($employees as $employee)
                                                    @if (!empty($assigned_asset->assigned_by) && empty($assigned_asset->headOfDepartment_id) && empty($assigned_asset->headOfSection_id) && ($employee->id == $assigned_asset->assigned_by))
                                                        <strong>SK: </strong>{{ $employee->first_name . ' ' . $employee->last_name }}

                                                    @elseif (!empty($assigned_asset->assigned_by) && !empty($assigned_asset->headOfDepartment_id) && empty($assigned_asset->headOfSection_id) && ($employee->id == $assigned_asset->headOfDepartment_id))
                                                        <strong>Dir: </strong>{{ $employee->first_name . ' ' . $employee->last_name }}

                                                    @elseif (!empty($assigned_asset->assigned_by) && !empty($assigned_asset->headOfDepartment_id) && !empty($assigned_asset->headOfSection_id) && ($employee->id == $assigned_asset->headOfSection_id))
