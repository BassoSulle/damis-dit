                                                        ...
                                                        <div class="col-12" style="margin-top: 8px;">
                                                            <select wire:model="role_id"class="form-control" id="condtion_id">
                                                                ...
                                                                @foreach ($roles as $role)
                                                                    @if (($role->name != 'head of section') && ($role->name != 'estate') && ($role->name != 'store keeper') && ($role->name != 'stock checker'))
                                            ...
                                            <div class="row" style="margin-bottom: 20px;">
                                                <div class="col-md-6">
                                                    <div class="row" style="align-content: left; margin-right: 20px;">
                                                        ...
                                                        <div class="col-12" style="margin-top: 8px;">
                                                            <p>{{ $HOS->first_name . ' ' . $HOS->last_name }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="row" style="align-content: left;">
                                                        ...
                                                        <div class="col-12" style="margin-top: 8px;">
                                                            @foreach ($employeeToAssign as $employee)
                                                                @if (!empty($role_id) && ($role_id == $employee->role_id)  && ($employee->role->name == 'head of section') && !empty($HOS->department_id) && ($HOS->department_id == $employee->department_id) && !empty($section_id) && ($section_id == $employee->section_id))
                                                                    <p>{{ $headOfSection }}</p>
                                                                
                                                                @elseif (!empty($role_id) && ($role_id == $employee->role_id)  && ($employee->role->name == 'head of office') && !empty($HOS->department_id) && ($HOS->department_id == $employee->department_id) && !empty($section_id) && ($section_id == $employee->section_id) && !empty($room_id) && ($room_id == $employee->room_id))
                                                                    <p>{{ $headOfOffice }}</p>
