            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        <li class="active">
                            <a href="{{ route('store.dashboard') }}" role="button" aria-expanded="false"><i
                                    class="fa big-icon fa-dashboard"></i> <span class="mini-dn"> Dashboard</span> </a>
                        </li>
                        <li class="active">
                            <a href="{{ route('store.registerAsset') }}" role="button" aria-expanded="false"><i
                                    class="fa big-icon fa-dashboard"></i> <span class="mini-dn"> Register Asset</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('store.assetInformation') }}" role="button" aria-expanded="false"><i
                                    class="fa big-icon fa-folder-open"></i> <span class="mini-dn">Asset
                                    Information</span> </a>
                        </li>

                        <li>
                            <a href="{{ route('store.assignAsset') }}" role="button" aria-expanded="false"><i
                                    class="fa big-icon fa-folder-open"></i> <span class="mini-dn">Assign Asset</span> </a>
                        </li>

                        <li>
                            <a href="{{ route('store.assetDisposition') }}" role="button" aria-expanded="false"><i
                                    class="fa big-icon fa-list-alt"></i> <span class="mini-dn">Asset Disposition</span>
                            </a>
                        </li>
                                    ...
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                        <li class="nav-item">
                                            <a href="#" data-toggle="dropdown" role="button"
                                                ...
                                                <span class="admin-name">{{ Auth::user()->last_name }}</span>
                                                <span
