            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        ...
                        <li>
                            <a href="{{ route('admin.floors') }}" role="button" aria-expanded="false"><i
                                    class="fa big-icon fa-file-archive-o"></i> <span class="mini-dn">Floors</span> </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.rooms') }}" role="button" aria-expanded="false"><i
                                    class="fa big-icon fa-file-archive-o"></i> <span class="mini-dn">Rooms</span> </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.employees') }}" role="button" aria-expanded="false"><i
                                    class="fa big-icon fa-file-archive-o"></i> <span class="mini-dn">Employees</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.assets') }}" role="button" aria-expanded="false"><i
