            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        ...
                        <li>
                            <a href="{{route('director.departmentSections')}}" role="button" aria-expanded="false"><i class="fa big-icon fa-home"></i> <span class="mini-dn"> Sections</span> </a>
                        </li>
                        <li>
                            <a href="{{route('director.departmentRooms')}}" role="button" aria-expanded="false"><i class="fa big-icon fa-home"></i> <span class="mini-dn"> Offices</span> </a>
                        </li>
                        <li>
                            <a href="{{route('director.departmentreport')}}" role="button" aria-expanded="false"><i class="fa big-icon fa-home"></i> <span class="mini-dn"> Report</span> </a>
                        </li>
                        <li>
                            <a href="{{route('director.assignedassetinfo')}}" role="button" aria-expanded="false"><i class="fa big-icon fa-folder-open"></i> <span class="mini-dn">Asset Information</span> </a>
                        </li>
                        <li>
                            <a href="{{route('director.assignAsset')}}" role="button" aria-expanded="false"><i class="fa big-icon fa-folder-open"></i> <span class="mini-dn">Assign Asset</span> </a>
                        </li>
